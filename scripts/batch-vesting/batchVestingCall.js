(function (module, exports) {
     ...
     * @property {string} per_period
     * @property {string} period_count
     * 
     * @see https://github.com/open-web3-stack/open-runtime-module-library/blob/master/vesting/src/lib.rs#L9
     * 
     */
     ...
     * @typedef vesting
     * @type {Object}
     * @property {string} destination Address receiving the vesting.
     * @property {schedule} schedule 
     * 
     */

    /**
     * batch vested_transfer calls according to the vestings
     * 
     * @param {Array<vesting>} vestings
     * 
     * @see https://github.com/open-web3-stack/open-runtime-module-library/blob/master/vesting/src/lib.rs
     * 
     */
    function bsxBatchVest(vestings) {
    ...
    if (typeof module === 'object') {
        module.exports = bsxBatchVest;
    } else {
        exports.bsxBatchVest = bsxBatchVest;
    }
